...
# ----------------------------------------------------------------------------------------------------------
# Only use this part if you want to change the files. The results with the means are already in the folder!
write.csv(mean_sides_2019, 'files/mean_sides_2019.csv')
write.csv(mean_region1_2019, 'files/mean_region1_2019.csv')
write.csv(mean_region2_2019, 'files/mean_region2_2019.csv')


table2019 <- with(main_data_2019, table(pol_side1, pol_side2))
table2014 <- with(main_data_2014, table(pol_side1, pol_side2))
write.csv(table2014, 'files/table2014.csv')
write.csv(table2019, 'files/table2019.csv')
...
write.csv(segg, 'files/listcountries20142019.csv')
