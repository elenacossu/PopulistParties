...
main_data_2014 <- raw_data %>% 
  ...
  #---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  dplyr::left_join(., country_regions, by = 'country') %>%                                                      #Joining the region dataset to the analysis dataset 
  #---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
main_data_2014[which(main_data_2014$party_code == 2406), "party_name"] <- "NA"
