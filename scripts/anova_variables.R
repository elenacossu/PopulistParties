...
# ANOVA and Post-hoc eu_position political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_position ~ pol_side2)
...
# ANOVA and Post-hoc eu_position region - SIGNIFICANT / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_position ~ region1)
...
# ANOVA and Post-hoc eu_salience political sides - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_salience ~ pol_side2)
...
# ANOVA and Post-hoc eu_salience region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_salience ~ region1)
...
# ANOVA and Post-hoc eu_dissent political sides - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_dissent ~ pol_side2)
...
# ANOVA and Post-hoc eu_dissent region - NS / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_dissent ~ region1)
...
# ANOVA and Post-hoc eu_intmark political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_intmark ~ pol_side2)
...
# ANOVA and Post-hoc eu_intmark region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_intmark ~ region1)
...
# ANOVA and Post-hoc eu_cohesion political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_cohesion ~ pol_side2)
...
# ANOVA and Post-hoc eu_cohesion region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_cohesion ~ region1)
...
# ANOVA and Post-hoc eu_foreign political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_foreign ~ pol_side2)
...
# ANOVA and Post-hoc eu_foreign region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_foreign ~ region1)
...
# ANOVA and Post-hoc eu_budgets political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_budgets ~ pol_side2)
...
# ANOVA and Post-hoc eu_budgets region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_budgets ~ region1)
...
# ANOVA and Post-hoc eu_ep political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_ep ~ pol_side2)
...
# ANOVA and Post-hoc eu_ep region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_ep ~ region1)
...
# ANOVA and Post-hoc eu_turkey political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_turkey ~ pol_side2)
...
# ANOVA and Post-hoc eu_turkey region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(eu_turkey ~ region1)
...
# ANOVA and Post-hoc lrecon political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(lrecon ~ pol_side2)
...
# ANOVA and Post-hoc lrecon region / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(lrecon ~ region1)
...
# ANOVA and Post-hoc lrecon_salience political sides - NS / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(lrecon_salience ~ pol_side2)
...
# ANOVA and Post-hoc lrecon_salience region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(lrecon_salience ~ region1)
...
# ANOVA and Post-hoc galtan political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(galtan ~ pol_side2)
...
# ANOVA and Post-hoc galtan region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(galtan ~ region1)
...
# ANOVA and Post-hoc galtan_salience political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(galtan_salience ~ pol_side2)
...
# ANOVA and Post-hoc galtan_salience region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(galtan_salience ~ region1)
...
# ANOVA and Post-hoc spendvtax political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(spendvtax ~ pol_side2)
...
# ANOVA and Post-hoc spendvtax region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(spendvtax ~ region1)
...
# ANOVA and Post-hoc deregulation political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(deregulation ~ pol_side2)
...
# ANOVA and Post-hoc deregulation region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(deregulation ~ region1)
...
# ANOVA and Post-hoc econ_interven political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(econ_interven ~ pol_side2)
...
# ANOVA and Post-hoc econ_interven region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(econ_interven ~ region1)
...
# ANOVA and Post-hoc civlib_laworder political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(civlib_laworder ~ pol_side2)
...
# ANOVA and Post-hoc civlib_laworder region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(civlib_laworder ~ region1)
...
# ANOVA and Post-hoc sociallifestyle political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(sociallifestyle ~ pol_side2)
...
# ANOVA and Post-hoc sociallifestyle region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(sociallifestyle ~ region1)
...
# ANOVA and Post-hoc religious_principle political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(religious_principles ~ pol_side2)

res.aov

pwc <- main_data_2019 %>% 
  rstatix::tukey_hsd(religious_principles ~ pol_side2)

pwc

# ANOVA and Post-hoc religious_principle region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(religious_principles ~ region1)

res.aov

pwc <- main_data_2019 %>% 
  rstatix::tukey_hsd(religious_principles ~ region1)

pwc

# ANOVA and Post-hoc immigrate_policy political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(immigrate_policy ~ pol_side2)
...
# ANOVA and Post-hoc immigrate_policy region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(immigrate_policy ~ region1)
...
# ANOVA and Post-hoc multiculturalism political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(multiculturalism ~ pol_side2)
...
# ANOVA and Post-hoc multiculturalism region - SIGNIFICANT / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(multiculturalism ~ region1)
...
# ANOVA and Post-hoc urban_rural political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(urban_rural ~ pol_side2)
...
# ANOVA and Post-hoc urban_rural region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(urban_rural ~ region1)
...
# ANOVA and Post-hoc regions political sides - NS / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(regions ~ pol_side2)
...
# ANOVA and Post-hoc regions region - NS / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(regions ~ region1)
...
# ANOVA and Post-hoc ethnic_minorities political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(ethnic_minorities ~ pol_side2)
...
# ANOVA and Post-hoc ethnic_minorities region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(ethnic_minorities ~ region1)
...
# ANOVA and Post-hoc nationalism political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(nationalism ~ pol_side2)
...
# ANOVA and Post-hoc nationalism region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(nationalism ~ region1)
...
# ANOVA and Post-hoc antielite_salience political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(antielite_salience ~ pol_side2)
...
# ANOVA and Post-hoc antielite_salience region - NS / NS !
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(antielite_salience ~ region1)
...
# ANOVA and Post-hoc corrupt_salience political sides - NS / NS !
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(corrupt_salience ~ pol_side2)
...
# ANOVA and Post-hoc corrupt_salience region - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(corrupt_salience ~ region1)
...
# ANOVA and Post-hoc redistributon political sides - SIGNIFICANT / S
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(redistribution ~ pol_side2)
...
# ANOVA and Post-hoc redistributon region - NS / NS
res.aov <- main_data_2019 %>% 
  rstatix::anova_test(redistribution ~ region1)
